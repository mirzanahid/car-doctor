...
import choseImg1 from '../../assets/icons/group.svg'
    ...
    <div className="container ">
      ...
      <div className="bg-dark1 py-100 px-75 rounded-md flex justify-between  items-start mb-130">
        <div className="flex items-center gap-20">
          ...
          <div>
            <p className="font-inter text-p3 text-white">
              We are open monday-friday
            </p>
            <h4 className="font-inter text-sub2 text-white mt-10">
              7:00 am - 9:00 pm
            </h4>
          </div>
        </div>
      ...
      <div className="mb-130">
        ...
        <div className="flex justify-between items-center mt-50">
          <div className="border border-dark6 rounded-md flex flex-col justify-center items-center w-[170px] h-[155px] hover:bg-primary hover:border-primary text-dark2  hover:text-white">
             <img src={choseImg1} alt="" />
             <h3 className="font-inter text-sub6  mt-20">Expert Team</h3>
          </div>
          <div className="border border-dark6 rounded-md flex flex-col justify-center items-center w-[170px] h-[155px] hover:bg-primary hover:border-primary text-dark2  hover:text-white">
             <img src={choseImg1} alt="" />
             <h3 className="font-inter text-sub6  mt-20">Expert Team</h3>
