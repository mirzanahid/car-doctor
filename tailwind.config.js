  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        h3: ["40px", { lineHeight: "40px", fontWeight: "600" }], // Heading 2
        // Subheading styles
        ...
        p4: ["18px", { lineHeight: "30px", fontWeight: "500" }], // Paragraph 2
      },
      colors: {
        primary:"#FF3811",
        dark1: "#151515",
    ...
    backgroundImage: {
      "dark-gradient":
        "linear-gradient(90deg, rgba(21,21,21,1) 0%, rgba(21,21,21,0) 100%);", // Example custom gradient
    },
  },
  screens: {
